...
public class Amazon {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement Boys = driver
				.findElement(By.xpath("//div[@class='s-suggestion-container']//span[contains(text(),'boys')]"));
		Boys.click();

		String word1 = driver.findElement(By.xpath("//span[contains(text(),'1-48')]")).getText();

		WebElement Boysword = driver
				.findElement(By.xpath("//div[@class='sg-col-inner']//span[contains(@class,'a-color-state')]"));
		String word2 = Boysword.getText();
		System.out.println(word1 + " " + word2);

		driver.findElement(
				By.xpath("//input[@type='checkbox']/following-sibling::i[contains(@class,'a-icon-checkbox')]")).click();
		driver.findElement(
				By.xpath("(//input[@type='checkbox']/following-sibling::i[contains(@class,'a-icon-checkbox')])[2]"))
		.click();
		...
		WebElement price = driver.findElement(By.xpath(
				"//div[@id='search']/div[1]/div[1]/div[1]/span[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/div[2]/a[1]/span[1]/span[2]/span[2]"));
